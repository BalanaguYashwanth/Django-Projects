...
function orderpost()
{
  ...
  xmlhttp.open("POST","https://getfertilizeritems.herokuapp.com/api/v1/orderdetailed/",true);
...
function contactpost()
{
  ...
  xmlhttp.open("POST","https://getfertilizeritems.herokuapp.com/api/v1/detailed/",true);
  xmlhttp.setRequestHeader("Content-type","application/json");
  xmlhttp.setRequestHeader("X-CSRFToken", csrfcookie());
...
function slidechange()
{
    ...
    xmlhttp.open("GET","https://getfertilizeritems.herokuapp.com/api/v1/slidedatadetailed/",true);
    xmlhttp.setRequestHeader("Content-type","application/json");
    xmlhttp.setRequestHeader("X-CSRFToken",csrfcookie());
    xmlhttp.send();
}
...
function change()
{
    ...
    xmlhttp1.open("GET","https://getfertilizeritems.herokuapp.com/api/v1/filesdatadetailed/",true);
