...
function put(id,name,file)
{
    ...
    xmlhttp.open("PUT","https://getfertilizeritems.herokuapp.com/api/v1/slidedataMoredetail/"+getid+"/",true);
...
function Delete(id)
{
    ...
    xmlhttp.open("DELETE","https://getfertilizeritems.herokuapp.com/api/v1/slidedataMoredetail/"+id+"/",true);
    xmlhttp.setRequestHeader("Content-type","application/json");
    xmlhttp.setRequestHeader("X-CSRFToken", csrfcookie());
    xmlhttp.send();
